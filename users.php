        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 class="modal-title" id="exampleModalScrollableTitle"><?php echo ucwords ($thisUser['name']);?></h2>
                </div>
                <div class="modal-body">
                    <form method="POST" action="users.php" enctype="multipart/form-data">
                        <div class="form-group pt-20">
                            <div class="col-sm-4">
                                <label for="name" class="pr-10"> User Name</label>
                            </div>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group pt-20">
                            <div class="col-sm-4">
                                <label for="buy" class="pr-10"> Email</label>
                            </div>
                            <div class="col-sm-8">
                                <input name="email" type="text" class="login-input" placeholder="Buying Amount"
                                 id="buy" value="<?php echo $thisUser['email']?>" required>
                            </div>
                        </div>
                        <div class="form-group pt-20">
                            <div class="col-sm-4">
                                <label for="pimage" class="pr-10"> User Avatar</label>
                            </div>
                            <div class="col-sm-8">
                            <div class="pl-20">
